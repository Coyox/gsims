...
var PurgeRowView = Backbone.View.extend({
    template: _.template("<td>Table</td>"
        + "<td><button class='purge-table btn btn-xs btn-primary center-block' id='<%= model.userid %>'>Purge Table</button></td>"),
